...
####################################################################################
# Script Name    :pc-cliente3-configuracao-de-rede.sh                              #
# Description    :Script para configuração de rede do pc-cliente3 do Laboratório 1 #
...
iface eth0 inet static
	address 10.$GRUPO.3.10/24
	gateway 10.$GRUPO.3.1

iface eth0 inet6 static
	address 4d0c:$GRUPO:0c00::10/40
	gateway 4d0c:$GRUPO:0c00::1
EOL
